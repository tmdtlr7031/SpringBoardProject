...
//	private SystemService systemService;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
		System.out.println("웹로그 인터셉터");
//		WebLog webLog = new WebLog();
//		String reqURL = request.getRequestURI();
//		String reqServletPath = request.getServletPath();
//		
//		// egov의 AuthenticInterceptor, IpObtainInterceptor가 있는데 굳이 또 체크를 해야할까..? 
//		// 그리고 egov의 저 두개도 하나로 합치면 나을꺼같은데..?아닌가..
		// ===> dispatcher-servlet.xml에 빈으로 등록안되서 사용안하는 상태
